...
public class Authority implements GrantedAuthority {
	...
	public static final String ADMININISTRADOR = "ADMINISTRADOR";
	public static final String USUARIO = "USUARIO";
	public static final String EMPRESARIO = "EMPRESARIO";
	...
	@NotBlank
	@Pattern(regexp = "^" + ADMININISTRADOR + "|" + USUARIO + "|" + EMPRESARIO + "$")
	@Override
	...
	public static Collection<Authority> listAuthorities() {
		...
		authority.setAuthority(ADMININISTRADOR);
		...
		authority = new Authority();
		authority.setAuthority(EMPRESARIO);
		result.add(authority);
