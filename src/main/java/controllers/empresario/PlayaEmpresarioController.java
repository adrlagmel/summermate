...
@Controller
@RequestMapping("/playa/empresario")
public class PlayaEmpresarioController extends AbstractController {
	...
	public PlayaEmpresarioController() {
		super();
	}
	...
	public ModelAndView list() {
		...
		result.addObject("requestURI", "playa/empresario/list.do");
		return result;
	}
	...
	public ModelAndView edit2(@RequestParam int playaId){
		...
		result.addObject("requestURI", "playa/empresario/edit.do?playaId="+p.getId());
		return result;
	}
